    ...
    const insertCoupon = async (req, res) => {
        try{
           ...
           if(!couponCode){
                ...
                console.log('The coupon : ',existCoupon);
                res.redirect('/admin/coupon-add?message=Coupon Name should be unique&type=error')
                     ...
                     res.redirect('/admin/coupon-add?message=Please enter the Description&type=error')
                        ...
                        res.redirect('/admin/coupon-add?message=Description should have atleast 20 words&type=error');
                    }else if(!discount){
                        ...
                        res.redirect('/admin/coupon-add?message=Please enter valid date&type=error');
                    }else{
