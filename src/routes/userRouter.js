...
//<------------ multer config -------------->
const storage = multer.diskStorage({ destination:(req, file, cb) => { cb(null,'../OneCart/src/public/images')  },
...
Router.post('/addTocartByWishlist',wishlistCtrl.addTocartByWishlist);
...
Router.get('/faq',isLoggedIn, userCtrl.getFaq);
Router.get('/aboutUs',isLoggedIn, userCtrl.getAboutUs);
